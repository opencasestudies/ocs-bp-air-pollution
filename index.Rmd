...
Wright, Carrie and Jager, Leah and Taub, Margaret and Hicks, Stephanie. (2020). [https://www.opencasestudies.org/ocs-bp-air-pollution/](https://www.opencasestudies.org/ocs-bp-air-pollution/). Predicting Annual Air Pollution (Version v1.0.0).
...
```{r}
(truth/pred) + plot_annotation(title = "A random forest model predicts true monitored levels of fine \nparticulate matter (PM 2.5) air pollution based on data about\npopulation density and other predictors reasonably well, thus\nbetter enabling prediction of pollution in places with poor\nmonitoring", theme = theme(title = element_text(size = 10)))
