...
Cross validation splits our training data into multiple training data sets to allow for an assessment of the accuracy of the model as we are training it.  (workflows::fit_resamples())
