...
```{r}
truth/pred + plot_annotation(title = "Random forest model predicts fine particulate matter (PM 2.5) \nair pollution based on data about road proximity, population density,\nand other predictors reasonably well")
...
AVOCADO response: oh I greatly prefer the first! it's awesome. However, in ppt whenever you take a screenshot, there are little red lines that appear under words that are not recognized by the dictionary. Instead, could you down the slide or take a screenshot from "presenter mode". that way there wont be any of the red lines underneath? 
...
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics(here::here("img","new_tidymodels_ecosystem.png"))
```
