...
It looks like the random forest model had  a much lower `rmse` value of 1.72. This suggest that this model is better at prediction air pollution values. In addition, the R squared value is higher, suggesting that 59% of the variance of the air pollution values could be explained by the model. 
