...
As mentioned, there are entirely scholarly fields of research dedicated to identifying different distance metrics $d(\cdot)$ for machine learning applications. 
...
AVOCADO: could we add the distance metrics themselves here? 
