...
knitr::include_graphics(here::here("www", "img", "main_plot_maps.png"))
```
...
knitr::include_graphics(here::here("www", "img", "pm2.5_scale_graphic-color_2.jpg"))
```
...
```{r, echo = FALSE, out.width= "800 px"}
knitr::include_graphics(here::here("www", "img", "particulate-size-chart.png"))
```
...
```{r, echo = FALSE, out.width= "800 px"}
knitr::include_graphics(here::here("www", "img", "sizes.jpg"))
```
...
```{r, echo = FALSE, out.width= "800 px"}
knitr::include_graphics(here::here("www", "img", "map_of_monitors.jpg"))
```
...
```{r, echo = FALSE, out.width= "800 px"}
knitr::include_graphics(here::here("www", "img", "thepaper.png"))
```
...
knitr::include_graphics(here::here("www", "img","2017deaths.png"))
```
...
```{r, echo = FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","2017mortality.png"))
```
...
```{r, echo = FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","PMworld.png"))
```
...
```{r, echo = FALSE}
knitr::include_graphics(here::here("www", "img", "US.png"))
```
...
```{r, echo = FALSE}
knitr::include_graphics(here::here("www", "img", "Kansas.png"))
```
...
When using supervised machine learning for prediction, where the outcome is needed (for more explanation of supervised vs unsupervised machine learning refer to [this](https://towardsdatascience.com/supervised-vs-unsupervised-learning-14f68e32ea8d){target="_blank"}), there are two main types of data of interest:
...
knitr::include_graphics(here::here("www", "img","monitor.png"))
```
...
knitr::include_graphics(here::here("www", "img","filter.png"))
```
...
```{r, echo = FALSE, out.width = "800px",}
knitr::include_graphics(here::here("www", "img", "regression.png"))
```
...
We have one CSV file that contains both our single **outcome variable** and all of our **features** (or predictor variables).You can find this data on our [GitHub repository](https://github.com/opencasestudies/ocs-bp-air-pollution/data/raw). Or you can download it more directly by clicking [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-air-pollution/master/data/raw/pm25_data.csv).
...
```{r, echo=FALSE}
pm <- readr::read_csv(here("www", "data","raw", "pm25_data.csv"))
```
...
```{r, echo=FALSE}
save(pm, file = here::here("www", "data", "imported", "imported_pm.rda"))
```
...
```{r, echo=FALSE}
load(here::here("www", "data", "imported", "imported_pm.rda"))
```

***
<details> <summary> If you skipped the data import section click here. </summary>

An RDA file (stands for R data) of the data can be found on our [GitHub repository](https://github.com/opencasestudies/ocs-bp-air-pollution/data/imported). Or you can download it more directly by clicking [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-air-pollution/master/data/imported/imported_pm.rda).
Download this file and then place it in your current working directory within a subdirectory called "imported" within a subdirectory called "data" to copy and paste our code. We used an RStudio project and the [`here` package](https://github.com/jennybc/here_here) to navigate to the file more easily. 
...
First let's save our data again because we did wrangle it just a tad. This time we will save it to a subdirectory of the "data" directory called "wrangled". This is a good practice in general for data analyses to keep your data oranganized. We will also save a csv version as this is often useful to give to collaborators. To do this we will use the `write_csv()` function of the `readr` package.
...
```{r dew_exercise, exercise=TRUE, exercise.eval = TRUE}
myplot
```

```{r dew_exercise-solution}
mydata %>%
  ggcorr(palette = "RdBu", label = TRUE)
```
...
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","simpletidymodels.png"))
```

This is a schematic of how these packages work together to build a machine learning algorithm:

```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","MachineLearning.png"))
```
...
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","Updated_tidymodels_basics.png"))
```
...
knitr::include_graphics(here::here("www", "img","split.png"))
```

If you were starting the case study around here, you can obtain the data  [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-air-pollution/master/data/wrangled/wrangled_pm.rda).

Load the data like so if you are starting here:
...
```{r, echo=FALSE}
load(here::here("www", "data", "wrangled", "wrangled_pm.rda"))
```

***
<details> <summary> If you skipped previous sections click here for more information. </summary>
Download this file by clicking this link [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-air-pollution/master/data/wrangled/wrangled_pm.rda) (same as above) and then place it in your current working directory within a subdirectory called "wrangled" within a subdirectory called "data" to copy and paste our code. We used an RStudio project and the [`here` package](https://github.com/jennybc/here_here) to navigate to the file more easily. 
...
knitr::include_graphics(here::here("www", "img","Starting_a_recipe_recipes1.png"))
```
...
```{r, echo=FALSE, out.width="400px"}
knitr::include_graphics(here::here("www", "img","Making_a_recipe_recipes2.png"))
```
...
```{r, echo=FALSE, out.width="400px"}
knitr::include_graphics(here::here("www", "img","training_preprocessing_recipes3.png"))
```
...
```{r, echo=FALSE, out.width="400px"}
knitr::include_graphics(here::here("www", "img","testing_preprocessing_recipes4.png"))
```
...
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","resampling.png"))
```
...
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img", "vfold.png"))
```
...
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img", "cross_validation.png"))
```
...
* Refer to the [`tidymodels` Steps](https://rsconnect.biostat.jhsph.edu/ocs-bp-air-pollution-interactive/#tidymodels_Steps) section. 
...
```{r da_exercise, exercise=TRUE, exercise.lines = 38, eval=FALSE}
...
```{r dv_exercise, exercise=TRUE}
world <- ne_countries(scale = "medium", returnclass = "sf")
ggplot(data = world) +
```

```{r dv_exercise-hint-1}
world <- ne_countries(scale = "medium", returnclass = "sf")
ggplot(data = world) +
    geom_sf()
```

```{r dv_exercise-hint-2}
world <- ne_countries(scale = "medium", returnclass = "sf")
ggplot(data = world) +
    geom_sf() +
...
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","full_tidymodels_overview.png"))
```
...
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","ecosystem.png"))
```
