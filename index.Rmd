...
In order to start this, we need to think about what each of the aspects of our data might do in the model. For example, is this particular column of data possibly helpful for predicting the outcome? Or are these the values that we would consider the outcome of interest? This process is described as assigning variables to specific roles within the model.
